...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_email)){
        ...
        $email_err = "Please enter a positive .";
    } else{
        $email = $input_email;
    }
    ...
    if(empty($name_err) && empty($number_err) && empty($email_err)){
        ...
        $sql = "UPDATE address_book SET name=?, number=?, email=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_number, $param_email, $param_id);
