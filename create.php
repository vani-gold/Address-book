...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    } elseif(ctype_alnum($input_email)){
    ...
    if(empty($name_err) && empty($number_err) && empty($email_err)){
        // Prepare an insert statement
        $sql = "INSERT INTO address_book (name, number, email) VALUES (?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sss", $param_name, $param_number, $param_email);
